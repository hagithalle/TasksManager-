        ...
        {activeTab === 'email' && (
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1, pt: 1 }}>
              ...
              <Tooltip title={copied ? t('share.copied', 'Copied!') : t('share.copyMailto', 'Copy mailto link')}>
                <span>
                  <Button
                    variant="outlined"
            ...
            <Alert severity="info" sx={{ borderRadius: 2, mt: 1 }}>
              <Typography variant="caption">
                {t('share.emailInfo', 'Click "Send Email" to open your default email client, or copy the link to send manually.')}
              </Typography>
            </Alert>
          </Box>
        )}
